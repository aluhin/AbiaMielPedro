...
<jsp:useBean id="errorBean" class="com.abiamiel.model.InfoBean" scope="request" />
...
<body>
	...
	<div id="page">
		<div id="content">
			<div id="welcome">
				<h1 class="title"><jsp:getProperty name = "errorBean" property = "title" /></h1>
				<div class="content">
					<p>
						<jsp:getProperty name = "errorBean" property = "description" />
					</p>
				</div>
			</div>
		</div>
		...
		<div id="sidebar">
			<div id="menu">
				<ul>
					...
					<li><a href="productos.html" accesskey="P" title=""><b>P</b>roductos</a></li>
					<li><a href="#" accesskey="V" title=""><b>V</b>enta</a></li>
					<li><a href="#" accesskey="Q" title=""><b>Q</b>uienes somos</a></li>
					<li><a href="#" accesskey="D" title=""><b>D</b>onde estamos</a></li>
				</ul>
			</div>
			<div id="links">
