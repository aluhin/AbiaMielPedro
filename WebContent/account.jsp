	...
	<div id="page">
		<div id="content">
			<div id="welcome">
				...
				<div class="content">
					<p>
						Bienvenido <jsp:getProperty name = "customer" property = "nick" /> a su sitio personalizado. Aqui podra realizar una 
						gestion de su cuenta y de sus pedidos. Para ello seleccione una de las siguientes opciones:
					</p>
				</div>
