	...
	<div id="page">
		<div id="content">
			<div id="welcome">
				...
				<div class="content">
					<p>Introduzca su nombre de usuario y contrasenia. Si no esta registrado, dese de alta 
						en el sistema en menos de un minuto haciendo click en el enlace de la derecha <strong>Registrarse</strong></p>
				</div>
			</div>
