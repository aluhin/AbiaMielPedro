...
import com.abiamiel.servlets.ActivationServlet;
...
public class HibernateUtil {
	...
	private static final int STARTING_TRANSACTIONS_RETRIES = 5;
	...
	public static boolean startTransaction(Session session) {
		...
		do {
			try {
				...
				logger.warn(String.format("Retrying (%d) creating transaction: %s", retries, e));
			}
		} while (!isTransactionCreated && retries < STARTING_TRANSACTIONS_RETRIES);
